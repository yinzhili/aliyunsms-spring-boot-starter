package com.apifan.framework.aliyunsms.component;
...
import com.apifan.framework.aliyunsms.vo.SmsMsgVO;
...
public class AliyunSmsHelper {
    ...
    public boolean send(SmsMsgVO smsMsg) {
        ...
        request.setTemplateParam(JsonUtils.toJson(smsMsg.getVars()));
